...
function Supprimer(id)
	  {
			...
			{
				document.location.href="pages_supp/supprimer_slider.php?ID="+id ;
			}			    
	  }			  
</script>	
					...
					<div class="ps-3">
						<nav aria-label="breadcrumb">
							<ol class="breadcrumb mb-0 p-0">
								...
								<li class="breadcrumb-item active" aria-current="page" style="color:black">Gestion des images de slider</li>
							</ol>
						</nav>
					</div>
				</div>
...
<?php
	...
	if(isset($_POST['enregistrer_mail'])){	
		...
		if($id==0){	
			...
			if($type1=="jpg" or $type1=="JPG" or $type1=="jpeg" or $type1=="JPEG" or $type1=="png" or $type1=="PNG" or $type1=="bmp" or $type1=="BMP" or $type1=="gif" or $type1=="GIF"){
				...
				$path = "assets/images/slid/".$file1; 
				$pathcomplete = "assets/images/slid/".$file1;
				move_uploaded_file($_FILES['image']['tmp_name'], $pathcomplete);

				$sql="INSERT INTO `slider`(`image`) VALUES ('".$pathcomplete."')";
				$req=mysql_query($sql);
			}
	...
	$req="select * from slider where id=".$id;
...
?>				
				...
				<form action="" method="POST" enctype="multipart/form-data"> 
					...
					<hr><b>Liste des images slider</b>
					<div class="col-md-12 row">
					<div class="table-responsive mt-3">
					   <table class="table align-middle mb-0" style="border: solid 1px;">
						   ...
						   <tbody>						
<?php
	$req1="select * from slider order by id";
...
?>			
								<tr style="border: solid 1px;">
									 <td>
										<?php if(file_exists($image)) { ?>
											<a href="<?php echo $image; ?>" target="_blank"><img src="<?php echo $image; ?>" style="width:80px;"></a>
										<?php } ?>											
									 </td>
									 <td>
