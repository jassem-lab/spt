...
function Supprimer(id)
	  {
			...
			{
				document.location.href="pages_supp/supprimer_newesletter.php?ID="+id ;
			}			    
	  }			  
</script>	
					...
					<div class="ps-3">
						<nav aria-label="breadcrumb">
							<ol class="breadcrumb mb-0 p-0">
								...
								<li class="breadcrumb-item active" aria-current="page" style="color:black">Gestion des Newsletter</li>
							</ol>
						</nav>
					</div>
				</div>
				...
				<div class="row">
					...
					<div class="table-responsive mt-3">
					   <table class="table align-middle mb-0" style="border: solid 1px;">
						   ...
						   <tbody>						
<?php
	$req1="select * from newsletter order by id desc";
